...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('👻 Oᴡɴᴇʀ', url='https://t.me/itz_sahil_official'),
                    InlineKeyboardButton('Gʀᴏᴜᴘ ❤️‍🔥', url='t.me/chat_official_sahil')
                ],[
                    InlineKeyboardButton('〄 Hᴇʟᴘ', callback_data='help'),
                    InlineKeyboardButton('⍟ Aʙᴏᴜᴛ', callback_data='about'),
                    
                   InlineKeyboardButton('🖤 Jᴏɪɴ Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ 🖤', url='t.me/Sahil_Official_Here')
                  ]]
            ...
            try:
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                         [
                          InlineKeyboardButton('Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ', url='t.me/TheSupportOfficial'),
                          InlineKeyboardButton('Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ', url='t.me/Itz_Sahil_Official')
                       ],[
                          InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/itz_sahil_official")
                         ]
                        ]
                    )
                )
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                     [
                      ...
                      InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/Chat_Official_Sahil")
                     ]
                    ]
                )
            )
